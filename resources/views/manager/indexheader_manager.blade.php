            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="/edit_profile"><i class="fa fa-edit" aria-hidden="true">Edit Profile</i></a></li>
                        <li><a href="/add_product"><i class="fa fa-plus" aria-hidden="true">Add Product</i></a></li>
                        <li><a href="/view_product"><i class="fa fa-product-hunt" aria-hidden="true">View Product</i></a></li>
                        <li><a href="/view_feedback"><i class="fa fa-comments" aria-hidden="true">Feedback View</i></a></li>
                        <li><a href="/view_customer"><i class="fa fa-user" aria-hidden="true">View Customer</i></a></li>
